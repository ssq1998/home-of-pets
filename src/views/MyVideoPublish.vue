<template>
    <div id="my-video-publish">
        <div class="my-video-publish-list" v-if="list.length">
            <div class="my-video-publish-item" v-for="(item,index) in list" :key="index">
              <router-link :to="{ name: 'ArticleDetail', params: { obj: item }}">
                <div class="video-box">
                    <video :src="item.uploadVideo[0]"></video>
                </div>
                <div class="my-video-publish-info">
                    <div class="my-video-publish-title">{{item.title}}</div>
...
#my-video-publish {
    ...
    .my-video-publish-list {
        padding: 20px;
        .my-video-publish-item:hover {
            .my-video-publish-info {
                .my-video-publish-title {
                    color: skyblue;
                }
            }
        }
        .my-video-publish-item {
            cursor: pointer;
            a {
                display: flex;
                .video-box {
