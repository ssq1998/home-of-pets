        ...
        <div class="publish-block">
          ...
          <div class="publish-content">
            <div class="publish-box">
              <router-link :to="{ name: 'PublishArticle', params: { block: 2 }}">
              ...
              <p class="publish-button-introduce">讨论,分享,喂养攻略</p>
            </div>
            <div class="publish-box">
              <router-link :to="{ name: 'PublishArticle', params: { block: 2 }}">
                <el-button class="publish-button">
              ...
              <p class="publish-button-introduce">绘图,写真,表情包</p>
            </div>
          </div>
        </div>
...
export default {
  ...
  async created() {
    ...
    const lanternContent = await axios.request({
      url: 'article/getCommunityLantern',
      method: 'post'
    })
    this.lanternList = lanternContent.data
