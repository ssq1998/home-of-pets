<template>
    <div id="my-article-publish">
        <div class="my-article-publish-list" v-if="list.length">
            <div class="my-article-publish-item" v-for="(item,index) in list" :key="index">
...
#my-article-publish {
    ...
    .my-article-publish-list {
        padding: 20px;
        .my-article-publish-item {
            .item-title {
                display: flex;
                align-items: center;
                height: 25px;
